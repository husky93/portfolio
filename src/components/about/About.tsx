              ...
              >
                <div className={styles.about_text}>
                  ...
                  <p className={styles.desc}>
                    Ever since I was a kid I was very tech-savvy and fascinated
                    by
                  ...
                  <p className={styles.desc}>
                    After many years I decided to revisit old passion of mine
                    and learn{' '}
                    <strong className={styles.highlighted}>
                    ...
                    Although there is still a lot for me to learn I believe I
                    can be a valuable asset to a web development team and
                    continue my growth working on real world projects. So if
                    you're looking for a motivated, willing-to-learn, developer
                    with a solid knowledge of modern JavaScript based
                    technologies and passion to build fast, functional,
                    accessible, responsive websites - hit me up 😁!
                  </p>
                </div>
              </Curtain>
            </div>
